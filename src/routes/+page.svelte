...
<section class="mt-2">
  ...
  <p class="mt-1 text-carvao/70">
    Survival Japanese and culture for Japan — listen, say it out loud, and don’t get lost.
  </p>
</section>
...
>
  ...
  <span class="min-w-0 flex-1">
    ...
    <span class="block text-xs text-carvao/60"
      >Get <b>Google Translate</b> and download <b>Japanese</b> for offline use — the camera reads
