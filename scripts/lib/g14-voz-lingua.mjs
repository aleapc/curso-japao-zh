...
const MARCAS = {
  ...
  // Japonês: o KANA (hiragana+katakana) é a marca única — o kanji ele divide com o
  // chinês, mas nenhuma frase japonesa real fica só em kanji. forte = kana;
  // propria inclui kanji para cobrir a frase inteira.
  ja: { nome: 'japonês', forte: /[぀-ヿ]/, propria: /[぀-ヿ一-鿿]/ },
